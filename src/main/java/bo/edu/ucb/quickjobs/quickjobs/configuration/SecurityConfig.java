...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .requestMatchers(HttpMethod.GET, "/api/v1/adresses/persons/**").hasAnyRole("Customer", "Employee")
               ...
               // .requestMatchers(HttpMethod.POST,"/api/v1/requests/**").hasRole("Customer")
                .requestMatchers(HttpMethod.POST,"/api/v1/requests/persons/**").hasAnyRole("Customer", "Employee")
                .anyRequest()
                .authenticated()
                .and()
